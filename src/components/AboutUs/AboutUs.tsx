...
export const AboutUs = () => (
  <PageContainer>
    <div className="text-center py-13">
      ...
      <MediumText weight="medium">Discover your tech or business path in 3 simple steps</MediumText>
    </div>
    <div className="py-12">
      <div className={styles.content}>
        <div className={styles.textCol}>
          <SubheadingText as="h2" weight="semibold">
            Who Are We?
          </SubheadingText>
          ...
          <MediumText>
            We provide personalized recommendations to guide you towards a fulfilling career both in
            Tech and Business.
          </MediumText>
          <MediumText>
        ...
        <img src={girl} alt="Smiling professional" className={styles.image} />
      </div>
    </div>
  </PageContainer>
);
